...
mod tests {
    ...
    fn test_is_synthetic_model_fireworks_prefix() {
        assert!(is_synthetic_model("accounts/fireworks/models/deepseek-v3-0324"));
    ...
    fn test_normalize_synthetic_model_hf() {
        ...
        assert_eq!(
            normalize_synthetic_model("hf:zai-org/GLM-4.7"),
            "glm-4.7"
        );
        assert_eq!(
    ...
    fn test_normalize_synthetic_model_passthrough() {
        assert_eq!(normalize_synthetic_model("claude-sonnet-4-5"), "claude-sonnet-4-5");
